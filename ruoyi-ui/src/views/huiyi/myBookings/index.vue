      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-if="scope.row.bookStatus !== '2' && scope.row.bookStatus !== '3'"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
...
<script>
import { listMyBookRoom, getBookRoom, addBookRoom, updateBookRoom, cancelBookRoom, getFreeTime } from "@/api/huiyi/bookRoom";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listMyBookRoom(this.queryParams).then(response => {
